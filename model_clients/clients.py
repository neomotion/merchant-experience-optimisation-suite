...
from model_clients.retry_logic import retry_with_exponential_backoff
...
class AWSBedrockClient(BaseModelClient):
    ...
    def send_request(self, prompt: str, image_base64: str = None) -> str:
        ...
        if image_base64 and "claude" or "bedrock" in self.model_name.lower():
        ...
        try:
            response = self.client.invoke_model(
                ...
                modelId=self.model_name,  # You'll need to make sure this is correct
            ...
            if "claude" or "bedrock" in self.model_name.lower() and "messages" in payload:
